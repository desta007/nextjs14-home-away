...
import { createReviewSchema, imageSchema, profileSchema, propertySchema, validatedWithZodSchema } from "./schema";
import db from "./db";
...
export const toggleFavoriteAction = async (prevState: {
  ...
  try {
    ...
    return {
      message: favoriteId? 'Remove from Faves' : 'Added to Faves'
    }
  } catch (error) {
    return renderError(error)
  }
...
export const fetchReservationStats = async() => {
  ...
  return {properties,nights: totals._sum.totalNights || 0, 
